...
function multiply(a, b) { //eslint-disable-line
    ...
    var product_string = 'The product of ' + a + ' and ' + b + ' is ' + productAnswer + ".";
    console.log('productAnswer: ' + productAnswer + '.' );
    return [productAnswer, product_string ]; 
}
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
        ...
        var sum_string =  + a + ' and ' + b + ' and ' + c + ' sum to ' + sumAnswer + ".";
        var product_string = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + productAnswer + ".";
        console.log('sumAnswer: ' + sumAnswer + '.' + 'productAnswer:' + productAnswer + '.' );
        return [sumAnswer, productAnswer, sum_string, product_string ]; 
    }
